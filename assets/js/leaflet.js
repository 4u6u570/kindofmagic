...
!function (t, i) {
    ...
    var me, fe, ge, ve = (Object.freeze || Object)({
            ...
            locate: function (t) {
                if (t = this._locateOptions = i({
                    ...
                    return this._handleGeolocationError({code: 0, message: "Geolocation not supported."}),
                    this;
            ...
            _initLayout: function () {
                ...
                Q(t, "leaflet-container" + (
                qi ? " leaflet-touch" : ""
            ) + (Yi ? " leaflet-retina" : "") + (Li ? " leaflet-oldie" : "") + (Ai ? " leaflet-safari" : "") + (this._fadeAnimated ? " leaflet-fade-anim" : ""));
                var i = q(t, "position");
            ...
            whenReady: function (t, i) {
                return this._loaded ? t.call(i || this, {target: this}) : this.on("load", t, i),
                this
            },
    ...
    var Me = Te.extend({
            ...
            expand: function () {
                ...
                return t < this._form.clientHeight ? (Q(this._form, "leaflet-control-layers-scrollbar"), this._form.style.height = t + "px") : tt(this._form, "leaflet-control-layers-scrollbar"),
    ...
    var Ge = qe.extend({
            ...
            _project: function () {
                ...
                if (n.distance === pi.distance) {
                    ...
                    this._radius = isNaN(l) ? 0 : h.x - e.project([
                        u,
                        t - l
                    ]).x,
    ...
    be.mergeOptions({
        ...
        unbindPopup: function () {
            return this._popup && (this.off({click: this._openPopup, keypress: this._onKeyPress, remove: this.closePopup, move: this._movePopup}), this._popupHandlersAdded =! 1, this._popup = null),
            this
        },
    ...
    $i && Pn.include(xn), be.include({
        ...
        _getPaneRenderer: function (t) {
            ...
            return void 0 === i && (i = this._createRenderer({pane: t}), this._paneRenderers[t] = i),
            i
        },
